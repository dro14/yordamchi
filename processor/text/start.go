...
• Bepul obunada menga *30ta* so'rov jo'natishingiz mumkin 🤩
...
• В бесплатной подписке, Вы можете отправить мне до *30* запросов 🤩
...
• You can send me up to *30* requests in your free subscription 🤩
...
var DearUser = map[string]string{
	"uz": `qadrli Foydalanuvchi`,

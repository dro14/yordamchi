...
• *Qo'shimcha ma'lumotlar manbasini* kiritish uchun shunchaki botga fayl yuboring
...
• Для добавления *источника дополнительной информации* просто отправьте боту файл	
...
• To add a *source of additional information*, just send a file to the bot
